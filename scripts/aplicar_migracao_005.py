...
Uso:
    python scripts/aplicar_migracao_005.py
"""
...
def aplicar_migracao():
    ...
    """
    print("=" * 80)
    print("APLICACAO DA MIGRACAO 005 - Geracao Automatica de ID")
    print("=" * 80)
    ...
    steps = [
        ...
        ("Criando tabela sequencias_ativo",
